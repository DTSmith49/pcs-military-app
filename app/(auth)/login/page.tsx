 ...
 * AUTH-01: Sign-in form (email + password + Google SSO button).
 */
'use client'
...
export default function LoginPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    // Read CSRF cookie and echo it as a header (double-submit pattern)
    ...
    <main className="flex min-h-screen items-center justify-center bg-gray-50 px-4">
      <div className="w-full max-w-md rounded-2xl bg-white p-8 shadow-md">
        ...
        <p className="mt-2 text-center text-sm">
          <Link href="/forgot-password" className="text-gray-400 hover:underline">Forgot password?</Link>
        </p>
      </div>
    </main>
  )
